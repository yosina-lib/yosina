...
pub struct ChainedTransliterator(pub Vec<Box<dyn Transliterator>>);

impl Transliterator for ChainedTransliterator {
    fn transliterate<'a, 'b>(
        &self,
        pool: &mut CharPool<'a, 'b>,
        input: &[&'a Char<'a, 'b>],
...
mod tests {
    ...
    use crate::transliterators::HiraKataCompositionTransliteratorOptions;
    ...
    fn test_chained_transliterator_creation() {
        ...
        let chain = ChainedTransliterator(vec![Box::new(first), Box::new(second)]);
    ...
    fn test_chained_transliterator_empty_chain() {
        let chain = ChainedTransliterator(vec![]);
    ...
    fn test_chained_transliterator_single_item() {
        ...
        let chain = ChainedTransliterator(vec![Box::new(first)]);
    ...
    fn test_mixed_transliterator_chain() {
        ...
        let chain = ChainedTransliterator(vec![Box::new(first_simple), manual]);
    ...
    fn test_error_propagation_in_chain() {
        ...
        let chain = ChainedTransliterator(vec![Box::new(first), Box::new(FailingTransliterator)]);
    ...
    fn test_performance_with_long_chain() {
        ...
        let chain = ChainedTransliterator(transliterators);
