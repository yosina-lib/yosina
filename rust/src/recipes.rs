...
impl TryFrom<&TransliteratorRecipe> for Vec<TransliteratorConfig> {
    type Error = TransliteratorFactoryError;
    fn try_from(value: &TransliteratorRecipe) -> Result<Vec<TransliteratorConfig>, Self::Error> {
        value.build()
    }
}
...
impl TransliteratorFactory for TransliteratorRecipe {
