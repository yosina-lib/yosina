...
pub enum TransliteratorConfig {
    ...
    #[serde(rename = "jisx0201-and-alike-halfwidth-to-fullwidth")]
    Jisx0201AndAlikeHalfwidthToFullwidth(Jisx0201AndAlikeTransliteratorOptions),
    #[serde(rename = "jisx0201-and-alike-fullwidth-to-halfwidth")]
    Jisx0201AndAlikeFullwidthToHalfwidth(Jisx0201AndAlikeTransliteratorOptions),
...
impl TransliteratorFactory for TransliteratorConfig {
    fn new_transliterator(&self) -> Result<Box<dyn Transliterator>, TransliteratorFactoryError> {
        ...
        match self {
            ...
            Jisx0201AndAlikeHalfwidthToFullwidth(options) => {
                let factory =
                    Jisx0201AndAlikeHalfwidthToFullwidthTransliteratorFactory(options.clone());
                factory.new_transliterator()
            }
            Jisx0201AndAlikeFullwidthToHalfwidth(options) => {
                let factory =
                    Jisx0201AndAlikeFullwidthToHalfwidthTransliteratorFactory(options.clone());
                factory.new_transliterator()
            }
...
mod tests {
    use super::{
        HiraKataCompositionTransliteratorOptions,
        Jisx0201AndAlikeFullwidthToHalfwidthTransliteratorFactory,
        Jisx0201AndAlikeHalfwidthToFullwidthTransliteratorFactory,
    ...
    fn test_all_manual_transliterators_handle_sentinels() {
        let transliterators: Vec<Box<dyn Transliterator>> = vec![
            HiraKataCompositionTransliteratorOptions::default()
                ...
                .unwrap(),
            Jisx0201AndAlikeHalfwidthToFullwidthTransliteratorFactory(
                Jisx0201AndAlikeTransliteratorOptions::default(),
            )
            .new_transliterator()
            .unwrap(),
            Jisx0201AndAlikeFullwidthToHalfwidthTransliteratorFactory(
