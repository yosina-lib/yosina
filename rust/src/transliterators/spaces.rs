...
static SPACES_MAPPINGS: phf::Map<&'static str, &'static str> = phf::phf_map! { "\u{180e}" => "" , "\u{feff}" => "" , "\u{200a}" => " " , "\u{2001}" => " " , "\u{2008}" => " " , "\u{2003}" => " " , "\u{2006}" => " " , "\u{202f}" => " " , "\u{205f}" => " " , "\u{a0}" => " " , "\u{2004}" => " " , "\u{2005}" => " " , "\u{2007}" => " " , "\u{3000}" => " " , "\u{2009}" => " " , "\u{2002}" => " " , "ㅤ" => " " , "\u{2000}" => " " , "\u{200b}" => " " , "ﾠ" => " " };
