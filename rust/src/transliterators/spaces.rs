...
static SPACES_MAPPINGS: phf::Map<&'static str, &'static str> = phf::phf_map! { "ﾠ" => " " , "\u{205f}" => " " , "\u{200a}" => " " , "\u{200b}" => " " , "\u{2005}" => " " , "\u{2009}" => " " , "ㅤ" => " " , "\u{2000}" => " " , "\u{2004}" => " " , "\u{180e}" => "" , "\u{feff}" => "" , "\u{a0}" => " " , "\u{2006}" => " " , "\u{2007}" => " " , "\u{2002}" => " " , "\u{202f}" => " " , "\u{3000}" => " " , "\u{2001}" => " " , "\u{2003}" => " " , "\u{2008}" => " " };
