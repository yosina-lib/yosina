...
static SPACES_MAPPINGS: phf::Map<&'static str, &'static str> = phf::phf_map! { "ㅤ" => " " , "\u{2003}" => " " , "\u{2001}" => " " , "\u{2007}" => " " , "\u{202f}" => " " , "\u{205f}" => " " , "\u{2008}" => " " , "\u{2005}" => " " , "\u{2004}" => " " , "\u{3000}" => " " , "\u{2002}" => " " , "\u{180e}" => "" , "\u{200a}" => " " , "ﾠ" => " " , "\u{200b}" => " " , "\u{2006}" => " " , "\u{feff}" => "" , "\u{a0}" => " " , "\u{2000}" => " " , "\u{2009}" => " " };
