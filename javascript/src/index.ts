...
import type { TransliteratorRecipe } from "./recipes.js";
...
export type { TransliteratorRecipe } from "./recipes.js";
 ...
 *
 * ```typescript
 * export const makeTransliterator = async (configsOrRecipe: (TransliteratorConfig | string)[] | TransliteratorRecipe) => {
