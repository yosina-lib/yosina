export const hiraganaKatakanaTable: [[string, string?, string?] | undefined, [string, string?, string?], string?][] = [
...
export const hiraganaKatakanaSmallTable: [string, string, string?][] = [
  ["\u{3041}", "\u{30a1}", "\uff67"], // ぁ, ァ
  ["\u{3043}", "\u{30a3}", "\uff68"], // ぃ, ィ
  ["\u{3045}", "\u{30a5}", "\uff69"], // ぅ, ゥ
  ["\u{3047}", "\u{30a7}", "\uff6a"], // ぇ, ェ
...
export const voicedCharacters: [string, string][] = hiraganaKatakanaTable.flatMap(([hiraganaTable, katakanaTable]) => [
  ...
  ...((katakanaTable[1] !== undefined ? [[katakanaTable[0], katakanaTable[1]]] : []) satisfies [string, string][]),
]);

export const semivoicedCharacters: [string, string][] = hiraganaKatakanaTable.flatMap(
  ([hiraganaTable, katakanaTable]) => [
    ...((hiraganaTable !== undefined && hiraganaTable[2] !== undefined
      ? [[hiraganaTable[0], hiraganaTable[2]]]
      : []) satisfies [string, string][]),
    ...((katakanaTable[2] !== undefined ? [[katakanaTable[0], katakanaTable[2]]] : []) satisfies [string, string][]),
  ],
);
