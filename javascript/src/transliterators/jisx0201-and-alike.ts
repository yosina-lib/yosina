...
const getFwdMappings = (() => {
  ...
  return ({
    ...
    return (mappingsVariations[key] ??= {
      ...
      ...(convertUnsafeSpecials ? Object.fromEntries(specialPunctuationsTable) : {}),
      ...(convertHiraganas ? lettersGRFwdMappingsHiragana : {}),
    });
  };
})();
...
const getRevMappings = (() => {
  ...
  return ({
    ...
    return (mappingsVariations[key] ??= {
      ...
      ...(convertUnsafeSpecials ? Object.fromEntries(specialPunctuationsTable.map((pair) => [pair[1], pair[0]])) : {}),
    });
  };
})();
...
const convertFullwidthToHalfWidth = (options: Options): ((_: Iterable<Char>) => Iterable<Char>) => {
...
const convertHalfwidthToFullwidth = (options: Options): ((_: Iterable<Char>) => Iterable<Char>) => {
...
const mergeWithFullwidthToHalfWidthConversionDefaults = (options: Options) =>
  Object.assign(
    {
      convertGL: true,
      convertGR: true,
      u005cAsYenSign: !options.u005cAsBackslash && !options.u00a5AsYenSign,
      u005cAsBackslash: !options.u005cAsYenSign && !options.u00a5AsYenSign,
      u007eAsFullwidthTilde: true,
      u007eAsWaveDash: true,
      u007eAsOverline: false,
      u007eAsFullwidthMacron: false,
      u00a5AsYenSign: false,
    },
    options,
  );

const mergeWithHalfWidthToFullwidthConversionDefaults = (options: Options) => {
  const u005cAsYenSign = options.u005cAsYenSign ?? !options.u005cAsBackslash;
  const u007eAsFullwidthTilde =
    options.u007eAsFullwidthTilde ??
    (!options.u007eAsWaveDash && !options.u007eAsOverline && !options.u007eAsFullwidthMacron);
  return Object.assign(
    {
      ...
      u007eAsWaveDash: !u007eAsFullwidthTilde && !options.u007eAsOverline && !options.u007eAsFullwidthMacron,
      u007eAsOverline: !u007eAsFullwidthTilde && !options.u007eAsWaveDash && !options.u007eAsFullwidthMacron,
      u007eAsFullwidthMacron: !u007eAsFullwidthTilde && !options.u007eAsWaveDash && !options.u007eAsOverline,
      u00a5AsYenSign: true,
    },
    options,
  );
...
export default (options: Options) => {
  return options.fullwidthToHalfwidth
    ? convertFullwidthToHalfWidth(mergeWithFullwidthToHalfWidthConversionDefaults(options))
    : convertHalfwidthToFullwidth(mergeWithHalfWidthToFullwidthConversionDefaults(options));
};
