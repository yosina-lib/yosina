...
def process_text_samples(samples)
  puts "Processing text samples with character codes:"
...
def main
  ...
  web_scraping_recipe = Yosina::TransliteratorRecipe.new(
    kanji_old_new: true,
    replace_spaces: true,
  ...
  document_recipe = Yosina::TransliteratorRecipe.new(
    to_fullwidth: true,
    replace_spaces: true,
    kanji_old_new: true,
    combine_decomposed_hiraganas_and_katakanas: true
  ...
  search_recipe = Yosina::TransliteratorRecipe.new(
    kanji_old_new: true,
    replace_spaces: true,
    to_halfwidth: true,
    replace_suspicious_hyphens_to_prolonged_sound_marks: true
  ...
  puts "5. Unicode Normalization Showcase"
  puts "   (Demonstrating various Unicode edge cases)"

  unicode_recipe = Yosina::TransliteratorRecipe.new(
    replace_spaces: true,
  ...
  unicode_samples.each do |text, description|
    ...
    puts "  Result: '#{normalized}' (#{description})"
    puts
  end
  ...
  perf_recipe = Yosina::TransliteratorRecipe.new(
    kanji_old_new: true,
    replace_spaces: true
  )
