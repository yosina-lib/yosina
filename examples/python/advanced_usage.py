...
def process_text_samples(samples: list[tuple[str, str]]) -> None:
    """Process a list of text samples and display results."""
    print("Processing text samples with character codes:")
...
def main() -> None:
    ...
    web_scraping_recipe = TransliteratorRecipe(
        kanji_old_new=True,
        replace_spaces=True,
    ...
    document_recipe = TransliteratorRecipe(
        to_fullwidth=True,
        replace_spaces=True,
        kanji_old_new=True,
        combine_decomposed_hiraganas_and_katakanas=True,
    ...
    search_recipe = TransliteratorRecipe(
        kanji_old_new=True,
        replace_spaces=True,
        to_halfwidth=False,
        replace_suspicious_hyphens_to_prolonged_sound_marks=True,
    ...
    unicode_recipe = TransliteratorRecipe(
        replace_spaces=True,
    ...
    for text, description in unicode_samples:
        normalized = normalizer(text)
        print(f"  Result: '{normalized}' ({description})")
        print()
    ...
    perf_recipe = TransliteratorRecipe(
        kanji_old_new=True,
        replace_spaces=True,
    )
