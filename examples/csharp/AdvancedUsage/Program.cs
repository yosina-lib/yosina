...
namespace YosinaExamples
{
    class AdvancedUsage
    {
        static void ProcessTextSamples(List<(string text, string description)> samples)
        {
            Console.WriteLine("Processing text samples with character codes:");
            foreach (var (text, description) in samples)
            {
                Console.WriteLine($"\n{description}:");
        ...
        static void Main(string[] args)
        {
            ...
            // 1. Web scraping text normalization
            {
                ...
                var webScrapingRecipe = new TransliteratorRecipe
                {
                    KanjiOldNew = true,
                    ReplaceSpaces = true,
            ...
            // 2. Document standardization
            {
                ...
                var documentRecipe = new TransliteratorRecipe
                {
            ...
            // 3. Search index preparation
            {
                ...
                var searchRecipe = new TransliteratorRecipe
                {
                    KanjiOldNew = true,
                    ReplaceSpaces = true,
            ...
            // 5. Unicode normalization showcase
            {
                ...
                var unicodeRecipe = new TransliteratorRecipe
                {
                    ReplaceSpaces = true,
                ...
                {
                    var normalized = unicodeNormalizer(text);
                    Console.WriteLine($"  Result: '{normalized}' ({description})");
                    Console.WriteLine();
                }
            }
            ...
            // 6. Performance considerations
            {
                ...
                var perfRecipe = new TransliteratorRecipe
                {
                    KanjiOldNew = true,
                    ReplaceSpaces = true
                };
