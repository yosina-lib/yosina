...
final class HiraKataCompositionTests: XCTestCase {
    func testHiraganaCombiningDakuten() {
        let transliterator = HiraKataCompositionTransliterator().stringTransliterator
    ...
    func testHalfwidthKatakana() {
        ...
        // Halfwidth katakana with combining marks
        XCTAssertEqual(transliterator.transliterate("ｶ\u{3099}"), "ガ")
        XCTAssertEqual(transliterator.transliterate("ｷ\u{3099}"), "ギ")
        XCTAssertEqual(transliterator.transliterate("ｸ\u{3099}"), "グ")
        XCTAssertEqual(transliterator.transliterate("ｹ\u{3099}"), "ゲ")
        XCTAssertEqual(transliterator.transliterate("ｺ\u{3099}"), "ゴ")

        XCTAssertEqual(transliterator.transliterate("ﾊ\u{3099}"), "バ")
        XCTAssertEqual(transliterator.transliterate("ﾊ\u{309A}"), "パ")
        XCTAssertEqual(transliterator.transliterate("ﾋ\u{3099}"), "ビ")
        XCTAssertEqual(transliterator.transliterate("ﾋ\u{309A}"), "ピ")

        // Halfwidth marks (when composeNonCombiningMarks is true)
        XCTAssertEqual(transliterator.transliterate("ｶ\u{FF9E}"), "ガ")
        XCTAssertEqual(transliterator.transliterate("ﾊ\u{FF9F}"), "パ")
    }
    ...
    func testNonCombiningMarks() {
        ...
        let transliterator1 = HiraKataCompositionTransliterator().stringTransliterator
        ...
        let transliterator2 = HiraKataCompositionTransliterator(options: options).stringTransliterator
