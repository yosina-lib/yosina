...
final class Jisx0201AndAlikeTests: XCTestCase {
    func testHalfwidthToFullwidth() {
        ...
        let transliterator = Jisx0201AndAlikeTransliterator(options: options).stringTransliterator
    ...
    func testSpecialCharactersForward() {
        var options = Jisx0201AndAlikeTransliterator.Options()
        options.fullwidthToHalfwidth = true
        let transliterator = Jisx0201AndAlikeTransliterator(options: options).stringTransliterator

        // Special katakana
        XCTAssertEqual(transliterator.transliterate("ヮヰヱヺ"), "ﾜｲｴｦﾞ")
        XCTAssertEqual(transliterator.transliterate("ヵヶ"), "ｶｹ")
    }
    ...
    func testTildeOverrides() {
        ...
        let transliterator2 = Jisx0201AndAlikeTransliterator(options: options).stringTransliterator
