...
class Yosina
{
     ...
     */
    public static function buildTransliteratorConfigsFromRecipe(TransliteratorRecipe $recipe): array
    {
     ...
     *
     * @param array<array{string, array<string, mixed>}|string>|TransliteratorRecipe $configsOrRecipe
     */
    public static function makeTransliterator(array|TransliteratorRecipe $configsOrRecipe): callable
    {
        if ($configsOrRecipe instanceof TransliteratorRecipe) {
