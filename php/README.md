...
// Create a simple transliterator for circled characters
$circledTransliterator = Yosina::makeTransliterator([
    ['circled-or-squared', []]
]);

$result = $circledTransliterator('①②③ⒶⒷⒸ'); // circled numbers and letters
echo $result; // "123ABC"

// Create a combined character transliterator
$combinedTransliterator = Yosina::makeTransliterator([
    ['combined', []]
]);

$result2 = $combinedTransliterator('␀␁␂'); // control pictures
echo $result2; // "NULSOHSTX"
```
