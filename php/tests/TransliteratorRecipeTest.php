...
class TransliteratorRecipeTest extends TestCase
{
    ...
    {
        $recipe = new TransliteratorRecipe(replaceSuspiciousHyphensToProlongedSoundMarks: true);
        $configs = $recipe->buildTransliteratorConfigs();
    ...
    {
        $recipe = new TransliteratorRecipe(replaceCircledOrSquaredCharacters: true);
        $configs = $recipe->buildTransliteratorConfigs();
    ...
    {
        $recipe = new TransliteratorRecipe(replaceCircledOrSquaredCharacters: 'exclude-emojis');
        $configs = $recipe->buildTransliteratorConfigs();
    ...
    {
        $recipe = new TransliteratorRecipe(replaceCombinedCharacters: true);
        $configs = $recipe->buildTransliteratorConfigs();
    ...
    {
        $recipe = new TransliteratorRecipe(replaceIdeographicAnnotations: true);
        $configs = $recipe->buildTransliteratorConfigs();
    ...
    {
        $recipe = new TransliteratorRecipe(replaceRadicals: true);
        $configs = $recipe->buildTransliteratorConfigs();
    ...
    {
        $recipe = new TransliteratorRecipe(replaceSpaces: true);
        $configs = $recipe->buildTransliteratorConfigs();
    ...
    {
        $recipe = new TransliteratorRecipe(replaceMathematicalAlphanumerics: true);
        $configs = $recipe->buildTransliteratorConfigs();
    ...
    {
        $recipe = new TransliteratorRecipe(combineDecomposedHiraganasAndKatakanas: true);
        $configs = $recipe->buildTransliteratorConfigs();
    ...
    {
        $recipe = new TransliteratorRecipe(replaceHyphens: true);
        $configs = $recipe->buildTransliteratorConfigs();
    ...
    public function testHyphensCustomPrecedence(): void
    {
        ...
        $recipe = new TransliteratorRecipe(replaceHyphens: $customPrecedence);
        $configs = $recipe->buildTransliteratorConfigs();
    ...
    {
        $recipe = new TransliteratorRecipe(toFullwidth: true);
        $configs = $recipe->buildTransliteratorConfigs();
    ...
    {
        $recipe = new TransliteratorRecipe(toFullwidth: 'u005c-as-yen-sign');
        $configs = $recipe->buildTransliteratorConfigs();
    ...
    {
        $recipe = new TransliteratorRecipe(toHalfwidth: true);
        $configs = $recipe->buildTransliteratorConfigs();
    ...
    {
        $recipe = new TransliteratorRecipe(toHalfwidth: 'hankaku-kana');
        $configs = $recipe->buildTransliteratorConfigs();
    ...
    {
        $recipe = new TransliteratorRecipe(removeIvsSvs: true);
        $configs = $recipe->buildTransliteratorConfigs();
    ...
    {
        $recipe = new TransliteratorRecipe(removeIvsSvs: 'drop-all-selectors');
        $configs = $recipe->buildTransliteratorConfigs();
