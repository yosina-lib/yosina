...
import 'transliterators/archaic_hirakatas_transliterator.dart';
...
import 'transliterators/small_hirakatas_transliterator.dart';
...
void registerGeneratedTransliterators(TransliteratorRegistry registry) {
  registry
    ...
    ..register(
        'archaicHirakatas', (options) => ArchaicHirakatasTransliterator())
    ..register('smallHirakatas', (options) => SmallHirakatasTransliterator())
