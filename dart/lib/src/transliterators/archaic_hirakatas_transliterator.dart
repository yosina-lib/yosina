...
class ArchaicHirakatasTransliterator implements Transliterator {
  /// Creates a new instance of [ArchaicHirakatasTransliterator].
  ///
  /// [options] are currently unused but reserved for future extensions.
  const ArchaicHirakatasTransliterator(
