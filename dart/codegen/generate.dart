...
''';
  ...
  String _renderHyphensTransliteratorData(List<dynamic> data) {
    ...
    buffer.writeln();
    buffer.writeln('/// Hyphens transliterator data.');
    buffer.writeln('const hyphensData = <String, Map<String, String?>>{');
  ...
  Future<void> _generateIvsSvsBinaryData(List<dynamic> data) async {
    final outputPath = path.join(destRoot, 'ivs_svs_base.data');
    ...
    for (final record in data) {
      if (record is Map) {
        ...
        buffer.add(_int32ToBytes(ivsCodepoint1));
        buffer.add(_int32ToBytes(ivsCodepoint2));
        ...
        buffer.add(_int32ToBytes(svsCodepoint1));
        buffer.add(_int32ToBytes(svsCodepoint2));
    ...
    print('Generated binary data file: $outputPath (${bytes.length} bytes)');
  }
...
''';
  ...
  String _renderCircledOrSquaredTransliteratorData(Map<String, dynamic> data) {
    ...
    buffer.writeln('// GENERATED CODE - DO NOT MODIFY BY HAND');
    buffer.writeln();
    buffer.writeln('/// Circled or squared transliterator data.');
    buffer.writeln(
        'const circledOrSquaredData = <String, Map<String, dynamic>>{');
    ...
    for (final entry in data.entries) {
      ...
      buffer.writeln("  '$from': {");
      buffer.writeln("    'rendering': '$rendering',");
      buffer.writeln("    'type': '$type',");
      buffer.writeln("    'emoji': $emoji,");
      buffer.writeln('  },');
    }
  ...
  Future<void> _generateRegistry() async {
    ...
    buffer.writeln('// GENERATED CODE - DO NOT MODIFY BY HAND');
    buffer.writeln();
    buffer.writeln('import \'transliterator_registry.dart\';');

    // Imports for generated transliterators
    for (final (identifier, className) in generatedTransliterators) {
