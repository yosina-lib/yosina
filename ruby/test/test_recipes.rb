...
class TestIndividualTransliterators < Minitest::Test
  ...
  def test_prolonged_sound_marks
    recipe = Yosina::TransliteratorRecipe.new(replace_suspicious_hyphens_to_prolonged_sound_marks: true)
    configs = recipe.build_transliterator_configs
  ...
  def test_circled_or_squared
    recipe = Yosina::TransliteratorRecipe.new(replace_circled_or_squared_characters: true)
    configs = recipe.build_transliterator_configs
  ...
  def test_circled_or_squared_exclude_emojis
    recipe = Yosina::TransliteratorRecipe.new(replace_circled_or_squared_characters: 'exclude-emojis')
    configs = recipe.build_transliterator_configs
  ...
  def test_combined
    recipe = Yosina::TransliteratorRecipe.new(replace_combined_characters: true)
    configs = recipe.build_transliterator_configs
  ...
  def test_ideographic_annotations
    recipe = Yosina::TransliteratorRecipe.new(replace_ideographic_annotations: true)
    configs = recipe.build_transliterator_configs
    assert contains_config(configs, :ideographic_annotations)
  end

  def test_radicals
    recipe = Yosina::TransliteratorRecipe.new(replace_radicals: true)
    configs = recipe.build_transliterator_configs
  ...
  def test_mathematical_alphanumerics
    recipe = Yosina::TransliteratorRecipe.new(replace_mathematical_alphanumerics: true)
    configs = recipe.build_transliterator_configs
    assert contains_config(configs, :mathematical_alphanumerics)
  end

  def test_hira_kata_composition
    recipe = Yosina::TransliteratorRecipe.new(combine_decomposed_hiraganas_and_katakanas: true)
    configs = recipe.build_transliterator_configs
...
class TestComplexOptions < Minitest::Test
  def test_hyphens_default_precedence
    recipe = Yosina::TransliteratorRecipe.new(replace_hyphens: true)
    configs = recipe.build_transliterator_configs
  ...
  def test_hyphens_custom_precedence
    ...
    recipe = Yosina::TransliteratorRecipe.new(replace_hyphens: custom_precedence)
    configs = recipe.build_transliterator_configs
  ...
  def test_to_fullwidth_basic
    recipe = Yosina::TransliteratorRecipe.new(to_fullwidth: true)
    configs = recipe.build_transliterator_configs
  ...
  def test_to_fullwidth_yen_sign
    recipe = Yosina::TransliteratorRecipe.new(to_fullwidth: 'u005c-as-yen-sign')
    configs = recipe.build_transliterator_configs
  ...
  def test_to_halfwidth_basic
    recipe = Yosina::TransliteratorRecipe.new(to_halfwidth: true)
    configs = recipe.build_transliterator_configs
  ...
  def test_to_halfwidth_hankaku_kana
    recipe = Yosina::TransliteratorRecipe.new(to_halfwidth: 'hankaku-kana')
    configs = recipe.build_transliterator_configs
  ...
  def test_remove_ivs_svs_basic
    recipe = Yosina::TransliteratorRecipe.new(remove_ivs_svs: true)
    configs = recipe.build_transliterator_configs
  ...
  def test_remove_ivs_svs_drop_all
    recipe = Yosina::TransliteratorRecipe.new(remove_ivs_svs: 'drop-all-selectors')
    configs = recipe.build_transliterator_configs
  ...
  def test_charset_configuration
    recipe = Yosina::TransliteratorRecipe.new(kanji_old_new: true, charset: 'adobe_japan1')
    configs = recipe.build_transliterator_configs
...
class TestMutualExclusion < Minitest::Test
  def test_fullwidth_halfwidth_mutual_exclusion
    recipe = Yosina::TransliteratorRecipe.new(to_fullwidth: true, to_halfwidth: true)
