...
Gem::Specification.new do |spec|
  ...
  spec.description = 'Yosina is a transliteration library that specifically deals with the letters and symbols used' \
                     ' in Japanese writing.'
  spec.homepage = 'https://github.com/moriyoshi/yosina'
  spec.license = 'MIT'
  ...
  spec.metadata['source_code_uri'] = 'https://github.com/moriyoshi/yosina'
  spec.metadata['changelog_uri'] = 'https://github.com/moriyoshi/yosina/blob/main/CHANGELOG.md'
