...
module Yosina
  ...
  #
  # @param configs_or_recipe [Array<TransliteratorConfig>, Array<String>, TransliteratorRecipe]
  ...
  def self.make_transliterator(configs_or_recipe)
    configs = case configs_or_recipe
              ...
              when Array
                ...
                raise ArgumentError, 'configs_or_recipe must be Array or TransliteratorRecipe'
              end
