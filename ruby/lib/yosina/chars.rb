...
module Yosina
  ...
  module Chars
    ...
    # @return [Array<Char>] A list of Char objects representing the input string,
    ...
    #
    # @param chars [Array<Char>] An array of Char objects
    # @return [String] A string composed of the non-empty characters
    def self.from_chars(chars)
      chars.map { |char| char.c unless char.c.empty? }.compact.join
    end
  end
end
