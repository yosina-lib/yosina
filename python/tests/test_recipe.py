...
from yosina.recipes import Mapping, TransliteratorRecipe, build_transliterator_configs_from_recipe
...
class TestIndividualTransliterators:
    ...
    def test_prolonged_sound_marks(self):
        ...
        recipe = TransliteratorRecipe(replace_suspicious_hyphens_to_prolonged_sound_marks=True)
        configs = build_transliterator_configs_from_recipe(recipe)
    ...
    def test_circled_or_squared(self):
        ...
        recipe = TransliteratorRecipe(replace_circled_or_squared_characters=True)
        configs = build_transliterator_configs_from_recipe(recipe)
    ...
    def test_circled_or_squared_exclude_emojis(self):
        ...
        recipe = TransliteratorRecipe(replace_circled_or_squared_characters="exclude-emojis")
        configs = build_transliterator_configs_from_recipe(recipe)
    ...
    def test_combined(self):
        ...
        recipe = TransliteratorRecipe(replace_combined_characters=True)
        configs = build_transliterator_configs_from_recipe(recipe)
    ...
    def test_ideographic_annotations(self):
        ...
        recipe = TransliteratorRecipe(replace_ideographic_annotations=True)
        configs = build_transliterator_configs_from_recipe(recipe)
    ...
    def test_radicals(self):
        ...
        recipe = TransliteratorRecipe(replace_radicals=True)
        configs = build_transliterator_configs_from_recipe(recipe)
    ...
    def test_spaces(self):
        ...
        recipe = TransliteratorRecipe(replace_spaces=True)
        configs = build_transliterator_configs_from_recipe(recipe)
    ...
    def test_mathematical_alphanumerics(self):
        ...
        recipe = TransliteratorRecipe(replace_mathematical_alphanumerics=True)
        configs = build_transliterator_configs_from_recipe(recipe)
    ...
    def test_hira_kata_composition(self):
        ...
        recipe = TransliteratorRecipe(combine_decomposed_hiraganas_and_katakanas=True)
        configs = build_transliterator_configs_from_recipe(recipe)
...
class TestComplexOptions:
    ...
    def test_hyphens_default_precedence(self):
        ...
        recipe = TransliteratorRecipe(replace_hyphens=True)
        configs = build_transliterator_configs_from_recipe(recipe)
    ...
    def test_hyphens_custom_precedence(self):
        ...
        recipe = TransliteratorRecipe(replace_hyphens=custom_precedence)
        configs = build_transliterator_configs_from_recipe(recipe)
    ...
    def test_to_fullwidth_basic(self):
        ...
        recipe = TransliteratorRecipe(to_fullwidth=True)
        configs = build_transliterator_configs_from_recipe(recipe)
    ...
    def test_to_fullwidth_yen_sign(self):
        ...
        recipe = TransliteratorRecipe(to_fullwidth="u005c-as-yen-sign")
        configs = build_transliterator_configs_from_recipe(recipe)
    ...
    def test_to_halfwidth_basic(self):
        ...
        recipe = TransliteratorRecipe(to_halfwidth=True)
        configs = build_transliterator_configs_from_recipe(recipe)
    ...
    def test_to_halfwidth_hankaku_kana(self):
        ...
        recipe = TransliteratorRecipe(to_halfwidth="hankaku-kana")
        configs = build_transliterator_configs_from_recipe(recipe)
    ...
    def test_remove_ivs_svs_basic(self):
        ...
        recipe = TransliteratorRecipe(remove_ivs_svs=True)
        configs = build_transliterator_configs_from_recipe(recipe)
    ...
    def test_remove_ivs_svs_drop_all(self):
        ...
        recipe = TransliteratorRecipe(remove_ivs_svs="drop-all-selectors")
        configs = build_transliterator_configs_from_recipe(recipe)
    ...
    def test_charset_configuration(self):
        ...
        recipe = TransliteratorRecipe(kanji_old_new=True, charset="adobe_japan1")
        configs = build_transliterator_configs_from_recipe(recipe)
...
class TestOrderVerification:
    ...
    def test_circled_or_squared_and_combined_order(self):
        ...
        recipe = TransliteratorRecipe(replace_circled_or_squared_characters=True, replace_combined_characters=True)
        configs = build_transliterator_configs_from_recipe(recipe)
...
class TestMutualExclusion:
    ...
    def test_fullwidth_halfwidth_mutual_exclusion(self):
        ...
        recipe = TransliteratorRecipe(to_fullwidth=True, to_halfwidth=True)
