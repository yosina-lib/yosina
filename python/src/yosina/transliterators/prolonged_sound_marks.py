        ...
        for char in input_chars:
            if lookahead_buf:
                ...
                if (prev_non_prolonged_char is None or prev_non_prolonged_char[1].is_alnum()) and (
                    ...
                    for buffered_char in lookahead_buf:
                        yield Char(c=buffered_char.c, offset=offset, source=buffered_char.source)
            ...
            if char.c in HYPHEN_LIKE_CHARS:
                should_process = not self.skip_already_transliterated_chars or char.source is None
