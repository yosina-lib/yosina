...
import lib.yosina.codegen.CircledOrSquaredRecord;
import lib.yosina.codegen.UnicodeUtils;
...
public class CircledOrSquared implements Transliterator {
    ...
    private static class CircledOrSquaredCharIterator implements CharIterator {
        ...
        private final Options options;
        private final List<lib.yosina.Char> queue = new ArrayList<>();
