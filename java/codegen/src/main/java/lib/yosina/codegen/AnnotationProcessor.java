...
@SupportedAnnotationTypes("lib.yosina.annotations.RegisteredTransliterator")
...
public class AnnotationProcessor extends AbstractProcessor {
    private static final String TRANSLITERATOR_ANNOTATION_TYPE =
            "lib.yosina.annotations.RegisteredTransliterator";
    private static final String TRANSLITERATORS_PACKAGE = "lib.yosina.transliterators";
