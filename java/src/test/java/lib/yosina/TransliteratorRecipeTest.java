...
import lib.yosina.transliterators.CircledOrSquared;
...
/** Comprehensive tests for TransliteratorRecipe functionality. */
public class TransliteratorRecipeTest {

    private TransliteratorRecipe recipe;
    ...
    class IndividualTransliterators {
        ...
        public void testCircledOrSquaredExcludeEmojis() {
            recipe.withReplaceCircledOrSquaredCharacters(
                    TransliteratorRecipe.ReplaceCircledOrSquaredCharactersOptions.EXCLUDE_EMOJIS);
            List<Yosina.TransliteratorConfig> configs = recipe.buildTransliteratorConfigs();
    ...
    class ComplexOptions {
        ...
        public void testHyphensDefaultPrecedence() {
            recipe.withReplaceHyphens(TransliteratorRecipe.ReplaceHyphensOptions.ENABLED);
            List<Yosina.TransliteratorConfig> configs = recipe.buildTransliteratorConfigs();
        ...
        public void testHyphensCustomPrecedence() {
            ...
            recipe.withReplaceHyphens(
                    TransliteratorRecipe.ReplaceHyphensOptions.withPrecedence(customPrecedence));
            List<Yosina.TransliteratorConfig> configs = recipe.buildTransliteratorConfigs();
        ...
        public void testToFullwidthBasic() {
            recipe.withToFullwidth(TransliteratorRecipe.ToFullwidthOptions.ENABLED);
            List<Yosina.TransliteratorConfig> configs = recipe.buildTransliteratorConfigs();
            ...
            assertFalse(options.isU005cAsYenSign());
        }

        @Test
        public void testToFullwidthYenSign() {
            recipe.withToFullwidth(TransliteratorRecipe.ToFullwidthOptions.U005C_AS_YEN_SIGN);
            List<Yosina.TransliteratorConfig> configs = recipe.buildTransliteratorConfigs();
            ...
            Jisx0201AndAlikeTransliterator.Options options =
                    (Jisx0201AndAlikeTransliterator.Options) config.getOptions().get();
            assertTrue(options.isU005cAsYenSign());
        }

        @Test
        public void testToHalfwidthBasic() {
            recipe.withToHalfwidth(TransliteratorRecipe.ToHalfwidthOptions.ENABLED);
            List<Yosina.TransliteratorConfig> configs = recipe.buildTransliteratorConfigs();
        ...
        public void testToHalfwidthHankakuKana() {
            recipe.withToHalfwidth(TransliteratorRecipe.ToHalfwidthOptions.HANKAKU_KANA);
            List<Yosina.TransliteratorConfig> configs = recipe.buildTransliteratorConfigs();
        ...
        public void testRemoveIvsSvsBasic() {
            recipe.withRemoveIvsSvs(TransliteratorRecipe.RemoveIvsSvsOptions.ENABLED);
            List<Yosina.TransliteratorConfig> configs = recipe.buildTransliteratorConfigs();
        ...
        public void testRemoveIvsSvsDropAll() {
            recipe.withRemoveIvsSvs(TransliteratorRecipe.RemoveIvsSvsOptions.DROP_ALL_SELECTORS);
            List<Yosina.TransliteratorConfig> configs = recipe.buildTransliteratorConfigs();
    ...
    class OrderVerification {
        ...
        public void testComprehensiveOrdering() {
            recipe.withKanjiOldNew(true)
                    ...
                    .withToHalfwidth(TransliteratorRecipe.ToHalfwidthOptions.ENABLED);
    ...
    class ComprehensiveConfiguration {
        ...
        public void testAllTransliteratorsEnabled() {
            recipe.withCombineDecomposedHiraganasAndKatakanas(true)
                    ...
                    .withRemoveIvsSvs(TransliteratorRecipe.RemoveIvsSvsOptions.DROP_ALL_SELECTORS)
                    .withReplaceHyphens(TransliteratorRecipe.ReplaceHyphensOptions.ENABLED)
                    ...
                    .withToHalfwidth(TransliteratorRecipe.ToHalfwidthOptions.HANKAKU_KANA)
