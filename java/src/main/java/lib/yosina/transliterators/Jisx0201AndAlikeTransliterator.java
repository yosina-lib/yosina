...
public class Jisx0201AndAlikeTransliterator implements Transliterator {
    ...
    public static class Options {
        private final boolean fullwidthToHalfwidth;
        ...
        /**
         * Creates a new Options instance with full configuration.
         *
         * @param fullwidthToHalfwidth if true, convert fullwidth to halfwidth; if false, convert
         *     halfwidth to fullwidth
         * @param convertGL convert GL area characters (ASCII-compatible)
         * @param convertGR convert GR area characters (katakana)
         * @param convertUnsafeSpecials convert special punctuation characters
         * @param convertHiraganas convert hiragana characters to halfwidth katakana
         * @param combineVoicedSoundMarks combine base characters with voiced/semi-voiced marks
         * @param u005cAsYenSign treat backslash (U+005C) as yen sign
         * @param u005cAsBackslash treat backslash (U+005C) as backslash
         * @param u007eAsFullwidthTilde treat tilde (U+007E) as fullwidth tilde
         * @param u007eAsWaveDash treat tilde (U+007E) as wave dash
         * @param u007eAsOverline treat tilde (U+007E) as overline
         * @param u007eAsFullwidthMacron treat tilde (U+007E) as fullwidth macron
         * @param u00a5AsYenSign treat yen sign (U+00A5) as yen sign
         */
        public Options(
         ...
         */
        public boolean isConvertUnsafeSpecials() {
         ...
         */
        public boolean isU005cAsBackslash() {
         ...
         */
        public boolean isU007eAsFullwidthTilde() {
         ...
         */
        public boolean isU007eAsWaveDash() {
         ...
         */
        public boolean isU007eAsOverline() {
         ...
         */
        public boolean isU007eAsFullwidthMacron() {
         ...
         */
        public boolean isU00a5AsYenSign() {
        ...
        public boolean equals(Object obj) {
            ...
            return fullwidthToHalfwidth == options.fullwidthToHalfwidth
                    ...
                    && convertUnsafeSpecials == options.convertUnsafeSpecials
                    && convertHiraganas == options.convertHiraganas
                    && combineVoicedSoundMarks == options.combineVoicedSoundMarks
                    && u005cAsYenSign == options.u005cAsYenSign
                    && u005cAsBackslash == options.u005cAsBackslash
                    && u007eAsFullwidthTilde == options.u007eAsFullwidthTilde
                    && u007eAsWaveDash == options.u007eAsWaveDash
                    && u007eAsOverline == options.u007eAsOverline
                    && u007eAsFullwidthMacron == options.u007eAsFullwidthMacron
                    && u00a5AsYenSign == options.u00a5AsYenSign;
        }
    ...
    public Jisx0201AndAlikeTransliterator(Options options) {
        ...
        this.forwardMappings = buildForwardMappings(this.options);
        this.reverseMappings = buildReverseMappings(this.options);
        this.voicedReverseMappings = buildVoicedReverseMappings(this.options);
    }

    private Options normalizeOptions(Options opts) {
        boolean u005cAsYenSign = opts.u005cAsYenSign;
        boolean u005cAsBackslash = opts.u005cAsBackslash;
        boolean u007eAsFullwidthTilde = opts.u007eAsFullwidthTilde;
        boolean u007eAsWaveDash = opts.u007eAsWaveDash;
        boolean u00a5AsYenSign = opts.u00a5AsYenSign;

        if (opts.fullwidthToHalfwidth) {
            // Default settings for fullwidth to halfwidth
            if (opts.convertGL && !opts.u005cAsBackslash && !opts.u00a5AsYenSign) {
                u005cAsYenSign = true;
                u005cAsBackslash = true;
            }
            if (opts.convertGL
                    && !opts.u007eAsFullwidthTilde
                    && !opts.u007eAsWaveDash
                    && !opts.u007eAsOverline
                    && !opts.u007eAsFullwidthMacron) {
            ...
            if (opts.convertGL) {
                u005cAsYenSign = opts.u005cAsYenSign || !opts.u005cAsBackslash;
                u005cAsBackslash = !u005cAsYenSign;
                u007eAsFullwidthTilde =
                        opts.u007eAsFullwidthTilde
                                || (!opts.u007eAsWaveDash
                                        && !opts.u007eAsOverline
        ...
        return new Options(
                opts.fullwidthToHalfwidth,
                opts.convertGL,
                opts.convertGR,
                opts.convertUnsafeSpecials,
                opts.convertHiraganas,
                opts.combineVoicedSoundMarks,
                u005cAsYenSign,
                u005cAsBackslash,
                u007eAsFullwidthTilde,
                u007eAsWaveDash,
    ...
    private Map<Integer, String> buildForwardMappings(Options opts) {
    ...
    private Map<Integer, Integer> buildReverseMappings(Options opts) {
    ...
    private Map<Integer, Map<Integer, Integer>> buildVoicedReverseMappings(Options opts) {
    ...
    public CharIterator transliterate(CharIterator input) {
        if (options.fullwidthToHalfwidth) {
            return new FullwidthToHalfwidthIterator(input);
        } else {
            return new HalfwidthToFullwidthIterator(input);
        }
    }
    ...
    private class FullwidthToHalfwidthIterator implements CharIterator {
        ...
        public FullwidthToHalfwidthIterator(CharIterator input) {
            this.input = input;
        }
    ...
    private class HalfwidthToFullwidthIterator implements CharIterator {
        ...
        public HalfwidthToFullwidthIterator(CharIterator input) {
            this.input = input;
        }
        ...
        public Char next() {
            ...
            if (options.combineVoicedSoundMarks && voicedReverseMappings.containsKey(codePoint)) {
                if (input.hasNext()) {
